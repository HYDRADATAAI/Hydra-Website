...
$Zip=Get-ChildItem "$HOME\Downloads\HYDRA_W7_BROWSER_RELEASE_SEAL_V002_READY*.zip" -File -ErrorAction SilentlyContinue |
    Sort-Object LastWriteTime -Descending | Select-Object -First 1
if(-not $Zip){throw "W7 V002 browser seal ZIP not found in Downloads"}
...
$Run="D:\HYDRA\WEBSITE_TESTS\W7_BROWSER_SEAL_V002_PACKAGE_$Stamp"
...
if(-not $Runner){throw "W7 V002 runner not found after extraction"}
